#ifndef rosic_MorphingFilter_h
#define rosic_MorphingFilter_h
...
namespace rosic
{
  ...
  Implement 2 instances of TeeBeeFilter, allowing crossfading between standard TB filter, band-pass and high-pass versions. 
